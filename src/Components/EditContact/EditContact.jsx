...
import { updateAsncy } from '../../Services/Actions/googleAction';
...
const EditContact = () => {
    ...
    const { user } = useSelector((state) => state.googleReducer);
    ...
    const inputRefs = {
        ...
        year: useRef(null),
        notes: useRef(null),
    }; // input box na focus ma rakhava mate
    ...
    const handleSubmit = (e) => {
        ...
        dispatch(updateAsncy(addContact))
        console.log("addContactnnnnnnnnnnnnnn", addContact);
                ...
                <div className='formm'>
                    ...
                    <div className='user'>
                        <div className='profile-icon position-relative'>
                            <img src={addContact.photo || userr} alt="User Profile" onClick={handleIconClick} />
                        ...
                        <form className='form' >
                            <div className='d-flex'>
                                ...
                                <div className='col-9'>
                                    <div className='enter'>
                                        <input type="text" className='input' name='name' value={addContact.name} onChange={handleEditContact} onBlur={toggleFilledClass} ref={inputRefs.name} placeholder=" " />
                                        <label className='line fw-medium'>First name</label>
                                    </div>
                                    <div className='enter mt-3'>
                                        <input type="text" className='input' name='surname' value={addContact.surname} onChange={handleEditContact} onBlur={toggleFilledClass} ref={inputRefs.surname} placeholder=" " />
                            ...
                            <div className='d-flex mt-4'>
                                ...
                                <div className='col-9'>
                                    <div className='enter'>
                                        <input type="text" className='input' name='company' value={addContact.company} onChange={handleEditContact} onBlur={toggleFilledClass} ref={inputRefs.company} placeholder=" " />
                                        <label className='line fw-medium'>Company</label>
                                    </div>
                                    <div className='enter mt-3'>
                                        <input type="text" className='input' name='job' value={addContact.job} onChange={handleEditContact} onBlur={toggleFilledClass} ref={inputRefs.job} placeholder=" " />
                            ...
                            <div className='d-flex mt-4'>
                                ...
                                <div className='col-9'>
                                    <div className='enter'>
                                        <input type="email" className='input' name='email' value={addContact.email} onChange={handleEditContact} onBlur={toggleFilledClass} ref={inputRefs.email} placeholder=" " />
                            ...
                            <div className='d-flex mt-4'>
                                ...
                                <div className='col-9'>
                                    <div className='enter'>
                                        <input type="tel" className='input' name='phone' value={addContact.phone} onChange={handleEditContact} onBlur={toggleFilledClass} ref={inputRefs.phone} placeholder=" " />
                            ...
                            <div className='d-flex mt-4'>
                                ...
                                <div className="col-2">
                                    <div className="enter">
                                        <input type="number" className="input w-100" name='day' value={addContact.day} onChange={handleEditContact} onBlur={toggleFilledClass} ref={inputRefs.day} placeholder=" " />
                                        <label className="line fw-medium">Day</label>
                                    </div>
                                </div>
                                <div className="col-4">
                                    <div className="enter">
                                        <select className="input w-100" name='month' value={addContact.month} onChange={handleEditContact} onBlur={toggleFilledClass} ref={inputRefs.month} placeholder=" ">
                                ...
                                <div className="col-4" style={{ width: '210px' }}>
                                    <div className="enter">
                                        <input type="number" className="input w-100" name='year' value={addContact.year} onChange={handleEditContact} onBlur={toggleFilledClass} ref={inputRefs.year} placeholder=" " />
                            ...
                            <div className='d-flex mt-4'>
                                ...
                                <div className='col-9'>
                                    <div className='enter'>
                                        <textarea type="text" className='input' rows="4" cols="50" name='notes' value={addContact.notes} onChange={handleEditContact} style={{ height: "80px" }} onBlur={toggleFilledClass} ref={inputRefs.notes} placeholder=" "></textarea>
